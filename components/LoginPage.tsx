        ...
        <div className="w-80 p-2     bg-blue-100">
            <div className="flex flex-col items-center justify-center mt-6">
                <div className="max-w-md w-full">
                    ...
                    <form className="space-y-4 mt-4 p-4 bg-white rounded-lg" onSubmit={handleSubmit}>
                        <div>
                            <label className="text-gray-800 text-sm mb-2 block font-semibold">Tài khoản</label>
                            <div className="relative flex items-center">
                                <input type={'text'} value={username} onChange={(e)=>setUsername(e.target.value)} name="username" required className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="nguyenvana" />
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input type={ showPassword ? 'text': 'password' } value={password} onChange={(e)=>setPassword(e.target.value)} name="password" required className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="••••••••" />
